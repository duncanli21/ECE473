...
void inline ENC_CLK_ENABLE(void)  {PORTE &= ~(0x80);}
void inline ENC_CLK_DISABLE(void) {PORTE |=   0x80 ;}

void inline ENC_PARALLEL_ENABLE(void)  {PORTE &= ~(0x40);}
void inline ENC_PARALLEL_DISABLE(void) {PORTE |=   0x40 ;}
